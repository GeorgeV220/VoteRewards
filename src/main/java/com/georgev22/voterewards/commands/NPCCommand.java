...
public class NPCCommand extends Command {
    ...
    public void execute(@NotNull final CommandSender sender, final String[] args) {
        if (!voteReward.getNoPlayerCharacterAPI().isHooked()) {
            BukkitMinecraftUtils.msg(sender, "&c&l(!) &cNPCs has not been hooked!");
            return;
        }
        BukkitMinecraftUtils.msg(sender, "&c&l(!)&c Commands &c&l(!)");
        BukkitMinecraftUtils.msg(sender, "&6/vnpc create");
        BukkitMinecraftUtils.msg(sender, "&6/vnpc remove");
        BukkitMinecraftUtils.msg(sender, "&6/vnpc update");
        BukkitMinecraftUtils.msg(sender, "&6/vnpc updateall");
    ...
    public void create(CommandSender sender, String @NotNull [] args) {
        if (args.length <= 1) {
            BukkitMinecraftUtils.msg(sender, "&c&l(!)&c Not enough arguments");
            return;
        }
        ...
        if (voteReward.getNoPlayerCharacterAPI().npcExists(args[0])) {
            BukkitMinecraftUtils.msg(sender, "&c&l(!)&c NPC " + args[1] + " already exists!");
            return;
        }

        if (!args[1].matches("-?(0|[1-9]\\d*)")) {
            BukkitMinecraftUtils.msg(sender, "&c&l(!)&c The position must be a number (1 - +∞)");
            return;
        }
        ...
        BukkitMinecraftUtils.msg(sender, "&a&l(!)&a Successfully created " + args[0] + " npc with position " + args[1] + "!");
    }
    ...
    public void remove(CommandSender sender, String @NotNull [] args) {
        ...
        if (voteReward.getNoPlayerCharacterAPI().npcExists(args[0])) {
            ...
            BukkitMinecraftUtils.msg(sender, "&a&l(!)&a Successfully removed " + args[0] + " npc!");
        } else {
            BukkitMinecraftUtils.msg(sender, "&c&l(!)&c NPC " + args[0] + " does not exists!");
        }
    }
    ...
    public void update(CommandSender sender, String @NotNull [] args) {
        ...
        if (voteReward.getNoPlayerCharacterAPI().npcExists(args[0])) {
            ...
            BukkitMinecraftUtils.msg(sender, "&a&l(!)&a Successfully updated " + args[0] + " npc!");
        } else {
            BukkitMinecraftUtils.msg(sender, "&c&l(!)&c NPC " + args[0] + " does not exists!");
        }
    }
    ...
    public void updateAll(CommandSender sender, String @NotNull [] args) {
        ...
        BukkitMinecraftUtils.msg(sender, "&a&l(!)&a All NPCs have been updated!");
    }
}